            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (typeof email == 'string') {
                        ...
                        email_1.default.sendMail(mailOptions, function (error, responses) {
                            console.log("if");
                            if (error) {
                                console.log('error');
                                res.json({ msg: error });
    ...
    route.post("/login", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    dbUser = _b.sent();
                    if (!(dbUser && typeof process.env.TOKEN_SECRET == 'string')) return [3 /*break*/, 3];
                    return [4 /*yield*/, bcrypt_1.default.compare(password, dbUser.Password)];
                case 2:
                    if (_b.sent()) {
                        user = {
                            id: dbUser.Id,
